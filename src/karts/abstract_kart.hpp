...
private:
    ...
    /** For data collection to get 1s intervals */
    float previousSaveTime;

    /** For data collection to get 1s intervals */
    float previousModelTime;
...
public:
    ...
    //
    float getPrevSaveTime() { return previousSaveTime; }
    //
    float getPrevModelTime() { return previousModelTime; }
    //
    float setPrevSaveTime(float currTime) { return previousSaveTime = currTime; }
    //
    float setPrevModelTime(float currTime) { return previousModelTime = currTime; }
};   // AbstractKart
